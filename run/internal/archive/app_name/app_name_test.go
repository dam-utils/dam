...
func TestName(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "Template",
			str:  "<имя приложения>-<версия приложения>.<8 символов контрольной суммы>-<размер в байтах>.dam",
			want: "<имя приложения>-<версия приложения>.<8 символов контрольной суммы>-<размер в байтах>.dam",
			err:  nil,
		},
		{
			name: "Name with '-' and '.'",
			str:  "def.app-name-1.2.3.0-0.dam",
			want: "def.app-name-1.2.3.0-0.dam",
			err:  nil,
		},
		{
			name: "Size is empty",
			...
			want: "",
			err:  fmt.Errorf("size is empty"),
		},
		{
			name: "Hash is empty",
			str:  "def.app-name-1.2.3.-0.dam",
			want: "",
			err:  fmt.Errorf("hash is empty"),
		},
		{
			name: "Bad format",
...
func TestDefaultString(t *testing.T) {
	...
	inf := NewInfo()
	want := "def_app_name-1.2.3.0-0.dam"
