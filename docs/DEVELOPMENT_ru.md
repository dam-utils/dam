...
- [install] метки family и multiversion желательно смотреть в списке `dam list --raw`
...
- [remove] dam remove удаляет по имени, а надо по имени и версии (multiversion) или id
