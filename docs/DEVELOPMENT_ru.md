...
- проверить работу с файлами (возможно неправильное закрытие файла при defer и os.Exit(1))
...
- когда парсим строку в files_db - смотреть длинну полей. Она должна совпадать с числом полей в app или repo
