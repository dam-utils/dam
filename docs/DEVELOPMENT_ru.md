...
- ботать лучше с абсолютными путями к файлам
...
- Внедрить метку FAMILY, чтобы не выводился ворнинг, при создании приложения
